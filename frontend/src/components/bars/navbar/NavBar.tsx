  ...
  return (
    <Navbar>
      <OpenButton onClick={() => dispatch(toggleSidebar(true))}>
        <MenuOpenIcon
          sx={{ color: theme.colors.lightGray, fontSize: "27px" }}
        />
      </OpenButton>
      <OpenButton>
        <CustomImage src={LightLogo} alt="light logog" width="100px" />
      </OpenButton>
      ...
      <CustomButton
        ...
        padding="5px 10px"
        width="fit-content"
        customStyles={`align-items:center; position:relative; background: linear-gradient(135deg, ${
          theme.colors.secondaryBackground
        }, ${theme.colors.primary + "55"}); justify-content:center`}
      >
