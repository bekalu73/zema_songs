...
export const CustomSideBar = () => {
  ...
  const { openSidebar, songStatistics } = useSelector(
    (store: RootState) => store.songs
  );
            ...
            if (button.type === "regular") {
              ...
              return (
                <CustomButton
                  ...
                  hoverBackgroundColor={theme.colors.primaryBackground}
                  gap="20px"
                  customStyles={
                    active
                ...
                >
                  ...
                  <CustomHeader
                    size="medium"
                    color={active ? color.primary : color.white}
                    weight="400"
                  >
                    {button.title}
                  </CustomHeader>
